...
# ============================================================
# TARGET MUSHROOMS CONFIG - BATCH 5
# ============================================================
MUSHROOMS = [
    {"id": "124102", "name": "21)_blushing_bracket"},
    {"id": "118041", "name": "22)_blushing_rosette"},
    {"id": "480776", "name": "23)_blushing_wood_mushroom"},
    {"id": "337850", "name": "24)_bovine_bolete"},
    {"id": "333772", "name": "25)_bronze_bolete"}
]
...
def scrape_species(species):
    ...
    logger.info(f"\n🚀 Starting Batch 5: {name} (ID: {taxon_id})")
    ...
    while current_total < TARGET_COUNT:
        ...
        try:
            ...
            page += 1
            time.sleep(3) # Safe delay for multiple parallel batches
...
def main():
    logger.info("🍄 Starting Batch 5 Downloader (Species 21-25)...")
